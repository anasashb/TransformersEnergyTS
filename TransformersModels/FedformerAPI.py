...
from torch import Tensor, diagonal, einsum, nn, optim
...
class FedformerTS:
    ...
    def __init__(self, model="Fedformer"):
        ...
        self.args.cross_activation = (
            "tanh"  # mwt cross atention activation function tanh or softmax
        )
        # Data
        ...
        self.args.model_id = (
            self.args.model + "_" + self.args.data + "_" + str(self.args.pred_len)
        )
        # Optimization
