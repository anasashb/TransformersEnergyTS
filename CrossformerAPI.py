...
class Dataset_SYNTH_additive_reversal(Dataset):
    ...
    New ARG:
        ...
        if not given, the function just defaults to the way Informer and Autoformer hourly data loaders make the split
    '''
    def __init__(self, root_path, data_path='SYNTH_additive_reversals.csv', flag='train', size=None,
                 data_split = [0.7, 0.1, 0.2], scale=True, inverse=False, scale_statistic=None):
...
class Dataset_SYNTH_multiplicative_reversal(Dataset):
    ...
    New ARG:
        ...
        if not given, the function just defaults to the way Informer and Autoformer hourly data loaders make the split
    '''
    def __init__(self, root_path, data_path='SYNTH_multiplicative_reversals.csv', flag='train', size=None,
                 data_split = [0.7, 0.1, 0.2], scale=True, inverse=False, scale_statistic=None):
